...
// Main lazy components with error boundaries
export const LazySkillsSection = ({ skills }: { skills: Skill[] }) => (
  <Suspense fallback={<SkillsLoader />}>
    <LazySkills skills={skills} />
  </Suspense>
);

export const LazyProjectsSection = ({ projects }: { projects: Project[] }) => (
  <Suspense fallback={<ProjectsLoader />}>
    <LazyProjects projects={projects} />
  </Suspense>
);

export const LazyExperienceSection = ({ experience, education }: { experience: Experience[]; education: Education[] }) => (
  <Suspense fallback={<ExperienceLoader />}>
    <LazyExperience experience={experience} education={education} />
  </Suspense>
);

export const LazyContactSection = ({ personalInfo }: { personalInfo: PersonalInfo }) => (
  <Suspense fallback={<ContactLoader />}>
    <LazyContact personalInfo={personalInfo} />
  </Suspense>
);

export const LazyFooterControlsSection = () => (
